...
namespace Programa09_04
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            //En esta pluma ponemos estilos de guion predeterminado
            Pen pluma2 = new Pen(Color.Green, 7);
            pluma2.DashStyle = DashStyle.Dash;//.DashDotDot etc, Aquí se escoge el estilo
            g.DrawLine(pluma2, 50,70,200,70);

            //Creamos nuestro porpio estilo de guion
